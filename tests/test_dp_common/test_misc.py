...
def test_version():
    ...
    v.version_check(provider_v_in="0.1.0", client_v_in="0.1.8")
    v.version_check(provider_v_in=Version("1.1.0"), client_v_in=Version("1.1.8"))
    ...
    with pytest.raises(v.VersionMismatch):
        v.version_check(provider_v_in="0.2.0", client_v_in="0.1.8")
    with pytest.raises(v.VersionMismatch):
        v.version_check(provider_v_in="2.1.0", client_v_in="1.1.0")
