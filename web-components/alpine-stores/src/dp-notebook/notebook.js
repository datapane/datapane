...
// JB - The require("jsdom") confuses the bundler graph as we don't have it installed.
// Resolve by commenting out as we always run in a browser, so the jsdom codepath will never be reached.
...
var getAnsi = function () {
    var lib =
        root.ansi_up || (typeof require === "function" && require("ansi_up"));
...
var getSanitizer = function () {
    var lib =
        root.DOMPurify ||
        (typeof require === "function" && require("dompurify"));
    if (isBrowser) {
